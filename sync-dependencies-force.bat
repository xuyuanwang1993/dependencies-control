...
pushd %OutPutPath%
cmake -DAUTO_SYNC_DENPENDECIES=ON -DOUT_PUT_PATH=%OutPutPath% -DENABLE_AUTO_CLEAN_REPO=ON -DDependenciesRootDir=%DenpendenciesDir% %ExtraCmakeConfig% -P  %~dp0/NativeDenpendencies.cmake
popd 